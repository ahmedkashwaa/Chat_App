...
public class MessagesAdapter extends RecyclerView.Adapter {
    ...
    public MessagesAdapter(Context context, ArrayList<com.example.whatsaap.Messages> messagesArrayList) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        com.example.whatsaap.Messages messages=messagesArrayList.get(position);
