        ...
        mupdateprofilebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if(imagepath!=null)
                {
                    ...
                    com.example.whatsaap.userprofile muserprofile =new com.example.whatsaap.userprofile(newname,firebaseAuth.getUid());
                    ...
                    Intent intent=new Intent(com.example.whatsaap.UpdateProfile.this, com.example.whatsaap.chatActivity.class);
